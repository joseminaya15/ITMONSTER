...
<html>
    <head>
        ...
        <title>HPE Panam&aacute; - Administrador de encuestas</title>
    ...
    <body>
        <div class="js-header js-fixed">
            ...
            <div class="js-header--right">
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-logout" onclick="cerrarCesionSurvey()">Cerrar sesi&oacute;n</button> 
            </div>
        </div>
                        ...
                        <table id="example" class="display nowrap table table-bordered table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                <tr class="tr-header-reporte">
                                    ...
                                    <th class="text-center">Preg. 7</th>
                                    <th class="text-center">Preg. 8</th>
