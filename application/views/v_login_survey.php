    ...
    <body>
        ...
        <section class="js-section js-height">
            ...
            <div class="js-container js-flex">
                <div class="js-login">
                    <h2>Administrador de encuestas</h2>
                    ...
                    <div class="col-xs-12 p-0">
                        <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect js-button js-button--login" onclick="ingresarSurvey()">Login</button>
                    </div>
                </div>
            </div>
        </section>
